...
async function main() {
  ...
  const filePath = 'D:\\[NEETpassionate] Quantitative Aptitude for Competitive Exam by R.S Aggrawal.pdf';
  ...
  const notebookId = 'aptitude-notebook-1';
  ...
  if (!existing) {
    ...
    const notebook: any = {
      ...
      userId: userId,
      owner: userId,
      title: `Quantitative Aptitude for Competitive Exam by R.S Aggrawal`,
      ...
      editors: [], viewers: [],
      description: `Complete book on Quantitative Aptitude by R.S Aggrawal.`,
    };
  ...
  const file: any = { 
    originalname: '[NEETpassionate] Quantitative Aptitude for Competitive Exam by R.S Aggrawal.pdf', 
