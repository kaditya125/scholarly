@echo off
REM Firestore Rules Deployment Script for NCERT Chapter Loading Fix
REM This script deploys the updated firestore.rules to fix PERMISSION_DENIED errors
