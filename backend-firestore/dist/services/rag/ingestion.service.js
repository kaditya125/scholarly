...
class IngestionService {
    ...
    async checkQuotas(userId, fileSizeInBytes) {
     ...
     */
    chunkText(text, targetTokens = 500, overlapTokens = 100) {
     ...
     */
    async ingestDocument(base64Data, mimeType, metadata) {
        ...
        const documentId = metadata.documentId || (0, uuid_1.v4)();
        const vectorDocs = [];
