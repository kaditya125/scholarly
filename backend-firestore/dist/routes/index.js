...
const coverage_routes_1 = __importDefault(require("./coverage.routes"));
const studyPlan_routes_1 = __importDefault(require("./studyPlan.routes"));
const pyq_routes_1 = __importDefault(require("./pyq.routes"));
const canonicalAssessment_routes_1 = __importDefault(require("./canonicalAssessment.routes"));
...
const savedMessage_routes_1 = __importDefault(require("./savedMessage.routes"));
const router = (0, express_1.Router)();
router.use('/analytics', analytics_routes_1.default);
router.use('/coverage', coverage_routes_1.default);
router.use('/study-plan', studyPlan_routes_1.default);
...
router.use('/saved-messages', savedMessage_routes_1.default);
...
router.use('/pyq', pyq_routes_1.default);
// J.7.1 — the only syllabus-backed assessment surface. See canonicalAssessment.routes.
router.use('/assessment', canonicalAssessment_routes_1.default);
router.use('/automations', automation_routes_1.default);
