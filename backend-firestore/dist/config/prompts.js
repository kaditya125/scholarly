...
function buildStudentContextBlock(ctx) {
    if (!ctx)
        return '';
...
function buildRecommendationsBlock(ctx) {
    if (!ctx)
        return '';
 ...
 */
function getGreetingOrOnboardingPrompt(ctx) {
    if (ctx.isFirstTimeUser || !ctx.isOnboarded) {
        return exports.ONBOARDING_PROMPT;
    }
