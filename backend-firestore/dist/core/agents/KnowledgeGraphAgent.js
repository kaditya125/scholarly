...
const graphRetrieval_service_1 = require("../../services/rag/graphRetrieval.service");
/**
...
class KnowledgeGraphAgent {
    ...
    async execute(context) {
        ...
        try {
            const result = await graphRetrieval_service_1.graphRetrievalService.getGraphContext(notebookId, query);
