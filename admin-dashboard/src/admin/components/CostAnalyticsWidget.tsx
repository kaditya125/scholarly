...
export const CostAnalyticsWidget: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCosts = async () => {
      try {
        ...
        console.error('Failed to fetch platform cost analytics:', err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 flex items-center justify-center h-48 animate-pulse">
