...
export function WeakSectionsPanel() {
  ...
  if (isLoading) {
    return <div className="h-[260px] rounded-xl border border-slate-200/80 dark:border-white/10 bg-slate-100/60 dark:bg-white/5 animate-pulse" />;
  }
  ...
  return (
    <motion.div
      ...
      className="rounded-xl border bg-white border-slate-200/80 dark:bg-white/[0.03] dark:border-white/[0.07] overflow-hidden"
    >
      {/* Narrative / progress report */}
      <div className="px-4 py-3.5 bg-slate-50/70 dark:bg-white/[0.02] border-b border-slate-100 dark:border-white/[0.06] relative">
        <div className="flex items-center gap-2 mb-1.5 relative z-10">
          ...
          <h3 className="text-[14px] font-semibold text-slate-900 dark:text-white">AI progress analysis</h3>
        </div>
        <p className="text-[12.5px] leading-relaxed text-slate-600 dark:text-slate-300 relative z-10">
      ...
      <div className="p-4">
        <div className="flex items-center gap-2 mb-3.5">
          ...
          <h4 className="text-[13px] font-semibold text-slate-900 dark:text-white">Priority weak sections</h4>
        </div>
        ...
        {weak.length === 0 ? (
          ...
          <div className="space-y-3">
            {weak.slice(0, 4).map((s) => (
              <div key={s.topic} className="p-3 rounded-lg border border-slate-200/80 dark:border-white/[0.08] bg-slate-50/60 dark:bg-white/[0.02]">
                ...
                <button
                  ...
                  className="w-full h-7 flex items-center justify-center gap-1.5 px-3 rounded-md bg-slate-900 hover:bg-slate-800 text-white dark:bg-[#c8e558] dark:hover:bg-[#bcd94c] dark:text-slate-900 text-[12px] font-semibold transition-all cursor-pointer shadow-xs"
                >
