...
export default function StudioSidebar({
  ...
  return (
    <div className="w-64 bg-gray-50 dark:bg-[#1a1d21] border-r border-gray-200 dark:border-gray-700 flex flex-col">
      {/* App Header */}
      ...
      <div className="px-3 pt-3">
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-[13px] font-semibold transition-colors shadow-sm"
        >
      ...
      <div className="px-3 py-3 border-b border-gray-200 dark:border-gray-700">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-[13px] bg-white dark:bg-[#2a2d32] border border-gray-200 dark:border-gray-600 rounded-md text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 outline-none focus:border-indigo-400 transition-colors"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide">
        ...
        <div className="px-2 py-2 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="w-full flex items-center gap-1.5 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
          >
            {projectsExpanded ? (
            ...
            {projects.length > 0 && (
              <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400 bg-gray-200/60 dark:bg-white/10 px-1.5 py-0.5 rounded-full normal-case tracking-normal">
                {projects.length}
              </span>
            )}
          </button>
    ...
    >
      ...
      {onDelete && (
        <button
          ...
          className="absolute top-1.5 right-1.5 p-1 rounded opacity-0 group-hover:opacity-100 focus:opacity-100 text-gray-400 hover:text-red-500 hover:bg-white dark:hover:bg-black/30 transition-all"
        >
...
function StatusGlyph({
    ...
    return (
      <Loader2
        className={cn(
          ...
          isLive ? 'text-indigo-500' : 'text-gray-400 dark:text-gray-500'
        )}
      />
    );
  }
  ...
  return (
    <span
      className="w-2 h-2 rounded-full bg-gray-300 dark:bg-gray-600 shrink-0 ml-0.5"
      aria-hidden
    />
  );
}
...
function EmptyProjects({
  ...
  if (hasQuery) {
    return (
      <div className="px-2 py-3 text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-900 dark:text-indigo-300'
    ...
    >
      ...
      {badge && (
        <span className="px-1.5 py-0.5 text-[10px] font-semibold rounded bg-indigo-600 text-white">
          {badge}
        </span>
      )}
    </button>
