...
import { X, Sparkles, Check, ShieldCheck, ArrowRight, Zap, MessageSquare, Mic, FileText, Headphones, Target } from 'lucide-react';
...
const SOURCE_DETAILS: Record<UpgradeSource, { title: string; subtitle: string; icon: any }> = {
  chat_limit: {
    ...
    subtitle: "You've used your 100 AI Chat messages for this month. Upgrade to Pro for up to 2,000 messages each month.",
    icon: MessageSquare,
  },
  voice_limit: {
    title: "You've reached your Free Voice Chat allowance",
    subtitle: "You've used your 15 minutes of Voice Chat for this month. Upgrade to Pro for up to 300 minutes (5 hours) of live spoken tutoring.",
    icon: Mic,
  },
  doc_limit: {
    title: "You've reached your Document Upload allowance",
    subtitle: "You've used your 5 document uploads for this month. Upgrade to Pro to upload up to 100 textbooks and notes.",
    icon: FileText,
  },
  podcast_limit: {
    title: "You've reached your Podcast Studio preview limit",
    subtitle: "You've generated your 1 free episode this month. Upgrade to Pro to generate up to 25 full multi-speaker podcast lessons.",
    icon: Headphones,
  },
  mock_test_limit: {
    title: "You've used your AI Mock Test generations",
    subtitle: "You've generated your 3 free AI tests this month. Upgrade to Pro for unlimited adaptive tests & diagnostic weakness heatmaps.",
    icon: Target,
  },
  premium_feature: {
    title: "Unlock this feature with Sadhya Pro",
    subtitle: "Get access to advanced study tools designed for deeper, faster exam preparation.",
    icon: Zap,
  },
  settings: {
...
const PRO_BENEFITS = [
  ...
  { text: 'Up to 100 document / PDF uploads (50MB per file)', highlight: '100 documents' },
  { text: '25 AI Podcast Studio episodes with cinematic mixing', highlight: '25 podcasts' },
  { text: 'Unlimited adaptive mock tests with weakness heatmaps', highlight: 'Unlimited tests' },
  { text: 'Priority server queue & direct expert support', highlight: 'Priority access' },
];
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="flex items-baseline gap-1 mt-1">
                  <span className="text-2xl font-black text-slate-900 dark:text-white">₹149</span>
                  <span className="text-[12px] text-slate-500 dark:text-slate-400">/ mo</span>
                </div>
                <div className="text-[11.5px] text-slate-600 dark:text-slate-400 mt-1">
                  ₹{PRO_YEARLY_TOTAL_INR.toLocaleString('en-IN')}/year &middot; 12 months access
                </div>
              </div>
            </div>

            {/* 7-Day Refund Guarantee Callout */}
            <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100/70 dark:bg-white/[0.03] border border-slate-200/50 dark:border-white/5 text-[12px] text-slate-600 dark:text-slate-400">
              <ShieldCheck className="w-4 h-4 text-[#8ba32b] shrink-0" />
              <span>
                <strong>7-Day Money-Back Guarantee:</strong> 100% full refund if you are not completely satisfied. Zero risk.
              </span>
            </div>
