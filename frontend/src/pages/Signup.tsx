        ...
        <div className="relative z-10">
          ...
          >
            <h1 className="text-4xl font-bold mb-6 leading-tight">
              A better way to prepare for your TRE Exams.
            </h1>
            <p className="text-slate-300 text-lg mb-12 max-w-md">
              Join thousands of educators who have already upgraded their test prep experience.
            </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 border-l border-transparent dark:border-white/5">
        ...
        >
          <div className="text-center lg:text-left mb-10">
            ...
            <p className="text-slate-500 dark:text-gray-400">Start your 7-day free trial today.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-slate-700 dark:text-gray-300">Target Exam</label>
              <div className="relative">
                <select className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-[#1f1f1f] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 dark:focus:border-indigo-500 transition-colors appearance-none cursor-pointer shadow-sm">
                  <option value="" disabled defaultValue="">Select your exam...</option>
                  <option value="prt">TRE PRT (Class 1-5)</option>
                  <option value="tgt">TRE TGT (Class 9-10)</option>
                  <option value="pgt">TRE PGT (Class 11-12)</option>
                </select>
                <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 dark:text-gray-500">
          ...
          <p className="mt-8 text-center text-slate-500 dark:text-gray-400 text-sm">
            Already have an account? <Link to="/signin" className="text-teal-600 dark:text-indigo-400 font-bold hover:underline">Sign in</Link>
          </p>
        </motion.div>
      </div>
    </div>
