              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {others.map((e) => (
                  <Link
                    key={e.slug}
                    to={`/exams/${e.slug}`}
                    className="inline-flex items-center gap-2 rounded-lg border border-slate-200 dark:border-white/10 px-3 py-1.5 text-[12.5px] font-medium text-slate-600 dark:text-gray-300 hover:border-slate-300 dark:hover:border-white/25 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group"
                  >
